...
import { Table, TableHead, TableRow, TableCell, TableBody, Paper, Button, Dialog, DialogTitle, DialogActions } from '@mui/material';
                ...
                <Table>
                    <TableHead>
                        <TableRow sx={{ fontWeight: 'bold' }}>
                            ...
                            <TableCell sx={{ width: '500px' }}>Message</TableCell> {/* Adjust width here */}
                    ...
                    <TableBody>
                        {feedbackData.map(feedback => (
                            <TableRow 
                                ...
                                <TableCell sx={{ width: '500px' }}>{feedback.message}</TableCell> {/* Adjust width here */}
                                <TableCell>
                                    <Button 
                                        variant="contained" 
                                        color="secondary" 
