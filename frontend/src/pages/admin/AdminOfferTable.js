...
import OfferAdd from "./AdminAddOfferPopup";
      ...
      >
          ...
          <TableBody>
            {offers.map((offer) => (
              ...
              >
                ...
                <TableCell>{offer.describe}</TableCell>
                <TableCell>{offer.duration}</TableCell>
                <TableCell>
                  <Button
                    variant="contained"
                    color="error"
                    onClick={() => handleOpenConfirmationDialog(offer._id)}
                  >
                    Delete
                  </Button>
                </TableCell>
        ...
        >
          ...
          <DialogActions>
            ...
            <Button onClick={handleDeleteOffer} autoFocus color="error">
              Delete
            </Button>
          </DialogActions>
        </Dialog>
