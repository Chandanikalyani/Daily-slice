...
const ReservationTable = () => {
    ...
    const handleConfirmAction = () => {
        if (actionType === 'accept') {
            ...
            updateReservationStatus(selectedReservationId, 'Rejected or Cancel');
    ...
    return (
        <>
            ...
            <br/>
            <div>
                <a href='/admin/adminreservedtablemanage'>
                <button style={{height:"50px",width:"200px",fontSize:"18px",borderRadius:"10px",marginLeft:"80%"}}>Reserved Table Manage</button>
                </a>
            </div>
            <br/>
            <br></br>
            <div>
                <h3 style={{color:"whitesmoke",textAlign:"center"}}>Pending Reservation Management Table</h3><br/>
            </div>
            <Paper sx={{
                margin: 'auto',
            ...
            <Dialog open={confirmDialogOpen} onClose={() => setConfirmDialogOpen(false)}>
                ...
                <DialogContent>
                    {actionType === 'accept' ? 'Are you sure you want to accept this reservation?' : 'Are you sure you want to cancel this reservation?'}
                </DialogContent>
                <DialogActions>
